...
membase* ParametersManager::allocate_parameters(memory::primitive_desc& dst_desc, float dst_scale, membase* src_data, std::vector<primitive> setup_ops){
...
membase* ParametersManager::allocate_parameters(memory::primitive_desc& dst_desc, membase* src_data, std::vector<primitive> setup_ops){
    return allocate_parameters(dst_desc, 1.f, src_data, setup_ops);
}
...
membase * DataPipelineManager::allocate_src(memory::primitive_desc &src_desc, float scale, std::vector<primitive> inference_ops) {
